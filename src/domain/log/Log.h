...
public:
   ...
   enum LogType 
   {
      RECEIVE_REQUEST_TOLAND= 1, TORELEASE_RUNWAY_TOLAND, STARTING_LANDING, RECEIVE_CONFIRMATION_OF_LANDING,
      RECEIVE_REQUEST_TOTAKEOFF, TORELEASE_RUNWAY_TOTAKEOFF, STARTING_TAKEOFF, RECEIVE_CONFIRMATION_OF_TAKEOFF,
   ...
   void generateLog(LogType type, std::string varValue = 0);
