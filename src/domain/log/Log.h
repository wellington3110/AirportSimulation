...
public:
   ...
   enum LogType 
   {
      RECEIVE_REQUEST_TOLAND= 1, TORELEASE_RUNWAY_TOLAND, RECEIVE_CONFIRMATION_OF_LANDING,
      RECEIVE_REQUEST_TOTAKEOFF, TORELEASE_RUNWAY_TOTAKEOFF, RECEIVE_CONFIRMATION_OF_TAKEOFF,
